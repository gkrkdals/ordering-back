...
CREATE TABLE `menu` (
  ...
  `price_category` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `PRICE_CATEGORY_FK` (`price_category`),
  CONSTRAINT `PRICE_CATEGORY_FK` FOREIGN KEY (`price_category`) REFERENCES `food_category` (`id`)
