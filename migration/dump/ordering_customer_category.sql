...
CREATE TABLE `customer_category` (
  ...
  `hex` char(6) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `customer_category_pk_2` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='고객 분류';
...
INSERT INTO `customer_category` VALUES (3,'즉시 결재','FFFFFF'),(4,'그릇 수거 때 결재','FF7F7F'),(5,'배달 전후 통장 결재','92D050'),(6,'주 단위 결재','FFEE8C'),(7,'월 단위 결재','4FC3F7');
