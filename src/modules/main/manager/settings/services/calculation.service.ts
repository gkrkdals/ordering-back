  ...
  async getEachCustomersSheet(
    ...
    for (const customer of customers) {
      ...
      const title2 = [
        ...
        { v: summary.earned_point, t: 'n', s: q },
        { v: summary.used_point, t: 'n', s: q },
        { v: summary.point_balance, t: 'n', s: q },
      ];
